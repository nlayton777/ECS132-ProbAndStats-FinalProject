...
When we fit a linear model on our training data set, the output returned is our sample estimate (estimate based on our sample data). The output that was returned can be found in Appendix~\ref{subsec:problem2coutput}.
